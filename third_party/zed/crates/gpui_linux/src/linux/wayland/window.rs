...
use gpui::{
    ...
    InitialWindowState, WindowAppearance, WindowBackgroundAppearance, WindowBounds, WindowControlArea, WindowControls,
...
impl WaylandSurfaceState {
    fn new(
        ...
        match params.initial_window_state {
            InitialWindowState::Windowed => {}
            InitialWindowState::Maximized => toplevel.set_maximized(),
            InitialWindowState::Fullscreen => toplevel.set_fullscreen(None),
        }
...
impl WaylandWindowState {
    pub(crate) fn new(
        ...
        Ok(Self {
            ...
            fullscreen: matches!(options.initial_window_state, InitialWindowState::Fullscreen),
