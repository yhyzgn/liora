...
impl Window {
    pub(crate) fn new(
        ...
        let initial_window_state = match window_bounds {
            WindowBounds::Windowed(_) => crate::InitialWindowState::Windowed,
            WindowBounds::Maximized(_) => crate::InitialWindowState::Maximized,
            WindowBounds::Fullscreen(_) => crate::InitialWindowState::Fullscreen,
        };
