...
//!
//! Aura apps can use the system window frame or opt into a lightweight custom
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(
                        div()
                            .id("aura-window-frame-drag-region")
