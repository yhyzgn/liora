...
**Files:**
- Modify: `crates/aura-components/src/input.rs`
...
Run `cargo run -p aura-gallery`, go to Form demo, and toggle password visibility. Verify no crash.

### Task 2: Implement Multi-row Textarea Height Fix

**Files:**
- Modify: `crates/aura-components/src/input.rs`
- Modify: `crates/aura-components/src/textarea.rs`
...
**Files:**
- Modify: `crates/aura-components/src/select.rs`
- Modify: `apps/aura-gallery/src/main.rs`
...
**Files:**
- Modify: `crates/aura-components/src/form.rs`
- Modify: `apps/aura-gallery/src/demos/form_demo.rs`
