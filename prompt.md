...
| **P14 延后高级组件补全** | `.prompt/P14-deferred-advanced.md` | 正在实现 P9 deferred backlog；Wave 1 已完成 Carousel、Calendar、InputTag；Wave 2 已完成 Mention、Watermark；Wave 3 已完成 TreeSelect；Wave 4 已完成 Tour；Wave 5 已完成 VirtualizedTable |
...
- P14 是延后高级组件补全阶段：从 P9 backlog 迁移而来，Wave 1 已完成 Carousel、Calendar、InputTag；Wave 2 已完成 Mention、Watermark；Wave 3 已完成 TreeSelect；Wave 4 已完成 Tour；Wave 5 已完成 VirtualizedTable；剩余继续 VirtualizedTree。详见 `.prompt/P14-deferred-advanced.md`。
...
3. **Install / uninstall smoke scripts**：已补 artifact smoke；仍待补真正安装/卸载级 deb/rpm/AppImage/macOS/Windows runner-safe checks。
