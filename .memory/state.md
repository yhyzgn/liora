...
- P15 Quality Hardening: active; Track A general CI gates are in place, and Track B API consistency has started with non-breaking `impl Into<Pixels>` builder normalization while preserving explicit `px(...)` call-site style.
...
| P15 Quality Hardening | 🔄 Active | Track B started | CI gates + API consistency |
