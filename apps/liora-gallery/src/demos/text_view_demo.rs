    ...
    fn render(&mut self, _window: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
        page(
            ...
            Space::new()
                ...
                .child(section(
                    "结构化文档块",
                    "直接用 block model 组合标题、段落、引用、列表和代码块，不依赖 Docs 私有 Markdown renderer。",
                    TextView::new([
                        ...
                        TextViewBlock::unordered(["Native selectable text", "Theme-aware quote and code surfaces", "Copyable code blocks"]),
                ...
                .child(section(
                    "快速 Markdown 子集",
                    "from_plain_markdown 适合应用内 help/about，不支持完整 CommonMark，也不会引入 WebView。",
                ...
                .child(section(
                    ...
                    TextView::new([
                        ...
                        TextViewBlock::ordered(["Keep content concise", "Use real components", "Avoid browser runtime"]),
                    ])
                    .selectable(false)
                    .max_width(px(680.0)),
                )),
