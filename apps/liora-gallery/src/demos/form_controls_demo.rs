...
impl InputUsage {
    fn new(cx: &mut Context<Self>) -> Self {
        ...
        Self {
            ...
            composite: cx.new(|cx| {
                Input::new("", cx)
                    .prepend_icon(liora_icons_lucide::IconName::User)
                    .append_text("Admin")
            }),
            ...
            icon: cx.new(|cx| {
                Input::new("", cx)
                    .placeholder("Search")
                    .icon_prefix(liora_icons_lucide::IconName::Search)
                    .clearable(true)
            }),
    ...
    cx.new(|cx| InputNumberUsage {
        ...
        vertical: cx.new(|cx| {
            InputNumber::new(5.0, cx)
                .min(0.0)
                .max(10.0)
                .controls_position(liora_components::InputNumberControlsPosition::Right)
        }),
