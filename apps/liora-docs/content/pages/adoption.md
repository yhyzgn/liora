...
Keep `gpui` and `gpui_platform` sourced from the official Zed repository at the same revision across the app and Liora to avoid duplicate framework versions.
