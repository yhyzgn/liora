...
1. Initialize Liora once with `liora::init_liora(cx)`; use `liora::init_liora_with_mode(cx, ThemeMode::Light | ThemeMode::Dark | ThemeMode::System)` when a product wants an explicit startup mode.
