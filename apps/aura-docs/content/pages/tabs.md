...
::AuraDemo{component="TabsStretch"}::
...
::AuraDemo{component="TabsBorderCard"}::
...
::AuraDemo{component="TabsPosition"}::
...
::AuraDemo{component="TabsEditable"}::
